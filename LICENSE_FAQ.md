...
Ontomir Non-Commercial License 1.0 (ENCL-1.0) was created by Tharsis Labs Ltd.
(Ontomir) to provide a mutually beneficial balance between the user benefits of
...
**Q: What is Ontomir Non-Commercial License 1.0 (ENCL-1.0)?**
...
blockchain consensus. The initial Designated Blockchains shall be the Ontomir
blockchains, identified by chain identifiers 9000 (testing network or testnet)
and 9001 (main network or mainnet).

Ontomir is currently building Ontomir, the commercial name of the software associated with the Ontomir repository,
to help developers to create their own EVM-compatible blockchain network with custom parameters.
You may use Ontomir for your commercial project, subject to the applicable Ontomir license.
For more information about Ontomir, check out the Ontomir Manifesto.
...
open source, such as empowering all non-Ontomir software developers to be part of
...
**A:** You may contact the legal department of licensor: os@Ontomir.org. They
...
**Q: What if I am currently using Ontomir code commercially in my business/project?**

**A:**You are allowed to continue using the code from older versions (<v13.0.0)
of Ontomir repository under LGPL 3.0, however, you must obtain a commercial permit
...
"Required Notice: Copyright Tharsis Labs Ltd. (Ontomir)(https://github.com/Ontomir)"
...
Ontomir does not claim it to be one. The legal phrasing of the ENCL 1.0 has been
...
planned to be included on Ethermint are instead going to be part of Ontomir.
For more information on the Ontomir, check out the Ontomir Manifesto.
...
permit from Ontomir for the ENCL code, but we will not grant rights to release the
...
**A:** First, a big thank you! You can contribute the code to the official Ontomir
